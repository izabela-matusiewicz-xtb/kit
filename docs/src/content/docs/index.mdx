...
<div style="background: linear-gradient(90deg, #3b82f6 0%, #8b5cf6 100%); color: white; padding: 1.5rem; border-radius: 0.75rem; margin: 1.5rem 0;">
  ...
  <p style="margin-bottom: 1rem; opacity: 0.9;">
    Kit includes a complete AI-powered PR reviewer that provides professional-grade code analysis with full repository context. 
    Choose from 10 models (from $0.005 to $0.91 per review) with transparent pricing and CI/CD integration.
  </p>
  <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
    ...
    <code style="background: rgba(0,0,0,0.2); padding: 0.5rem; border-radius: 0.25rem; font-size: 0.875rem;">
...
<CardGroup cols={2}>
  <Card title="🚀 AI PR Reviewer" href="/pr-reviewer">
    Production-ready AI PR reviewer with 10 models, transparent pricing, CI/CD integration, and roadmap.
  </Card>
