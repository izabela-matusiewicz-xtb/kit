...
- Cost: $0.025-0.045 per typical PR
- Speed: 15-30 seconds
- Uses kit's symbol analysis and cross-codebase impact assessment

**Agentic Mode**
- Multi-turn analysis with strategic tool usage
- Budget config (8 turns): $0.20-0.30, exceptional depth
- Thorough config (20 turns): $0.35-0.50, maximum analysis
...
- Standard mode: $0.50-1.00/month
- Mixed usage: $1.50-2.50/month

*Enterprise (500 PRs/month):*
- Standard mode: $12.50-22.50/month  
- Mixed usage: $40.00-60.00/month

**Cost per PR by complexity:**
- Simple (1-2 files): $0.01-0.03
- Medium (3-5 files): $0.03-0.06
- Complex (6+ files): $0.06-0.12
